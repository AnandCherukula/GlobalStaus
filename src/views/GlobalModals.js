...
//     return <Card style={{boxShadow:"0 4px 5px 0 rgba(0,0,0,.14), 0 1px 10px 0 rgba(0,0,0,.12), 0 2px 4px -1px rgba(0,0,0,.2)"}} >
//         <CardHeader>
...
import { IsProduction} from '../GlobalVars';
...
export function DisplayProfilePic(Base64) {
    ...
    return <img style={{ borderRadius: '50%', height: 50, width: 50 }}                    
        src={  Base64 ==undefined ? DefaultProfilePic: IsProduction ? "data:image/jpg;base64," +  Base64 : 
        // require('../../../services/PE.Web/Images/'+ Base64) 
        DefaultProfilePic
     }
    />
}
